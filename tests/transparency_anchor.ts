...
describe('transparency', () => {
  ...
  describe('Testing createPost transactions', async () => {
    ...
    it('Fails to create a post - not nft token account owner', async () => {
      // Get the nft accounts.
      const nftAccounts = await getNFTAccounts(NFT_HOLDING_KEYPAIR.publicKey);
  ...
  describe('Testing updatePost transactions', async () => {
